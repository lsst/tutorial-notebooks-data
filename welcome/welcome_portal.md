...
* [Firefly documentation](https://data-int.lsst.cloud/portal/app/onlinehelp/)
...
* [Notebook tutorials github repo](https://github.com/lsst/tutorial-notebooks/)
...
**Citing tutorials**: Publications that made use of the tutorials can cite the NSF-DOE Vera C. Rubin Observatory (2025), "Rubin Observatory LSST Tutorials", using [doi.org/10.11578/rubin/dc.20250909.20](http://doi.org/10.11578/rubin/dc.20250909.20).
